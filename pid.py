...
class PID_ctrl:
    ...
    def __update(self, stamped_error):
        ...
        stamp = Time.from_msg(stamped_error[1])
        ...
        for i in range(1, len(self.history)):
            ...
            error_dot += (self.history[i][0] - self.history[i-1][0]) / dt if dt > 0 else 0
        ...
        self.logger.log_values([latest_error, error_dot, error_int, stamp.nanoseconds])
