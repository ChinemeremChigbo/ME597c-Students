...
class particleFilter(Node):
    ...
    def initializeParticleFilter(self, x, y, th):
        ...
        self.particlePoses = np.column_stack((
            np.random.normal(x, self.std_particle_x, self.numParticles),
            np.random.normal(y, self.std_particle_y, self.numParticles),
            np.random.normal(th, self.std_particle_theta, self.numParticles)
